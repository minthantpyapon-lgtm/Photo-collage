...
<div id="top-controls">
  ...
  <div class="btn-group">
    <button class="btn-layout" onclick="toggleLayout()">↔ Switch Layout</button>
  ...
  <div class="btn-group">
    ...
    <button id="delBtn" class="btn-del" onclick="deleteSelectedText()">🗑️</button>
    <button class="btn-dl" onclick="downloadCollage()">💾 Download</button>
  </div>
</div>
